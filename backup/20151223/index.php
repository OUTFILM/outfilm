...
<div id="site_container">
    ...
    <div style="height: 443px; width: 1040; margin-top: 30px;margin-left: auto;margin-right:auto;">
        <? showSlideshow(); ?>
    </div>  
    <!--
    ...
    <!-- GET 10 MOVIES HERE! -->
    <div><h1 style="text-align: center; margin-top: 50px;">影视作品</h1></div>
    <div class="container_123" style="width: 1050px; margin: 0; float: left; border: none; margin-left: 110px;">
