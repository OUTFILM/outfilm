...
<div id="site_container">
	...
	<div id="page_container" style="/* border-bottom: 1px solid black; border: 10px solid red;*/">
	            <!-- tags -->
            <div id="tag_cont" style="float: left; margin-top: 20px; border-radius: 8px">  
            <?            
            $tags = array("电影", "喜剧", "浪漫", "肮脏的", "戏剧", "黑色幽默", "愚蠢", "悬念", "弄乱", "现实", "音乐", "百老汇", "20世纪90年代", "科幻" );			
	...
	<div style="height: 500px; width: 100%; float: left; margin-top: 10px;">
		<? showSlideshow(); ?>
	</div>	
    <!--
	...
	<!-- GET 10 MOVIES HERE! -->
	<div><h1 style="text-align: center; margin-top: 0px;">影视作品</h1></div>
	<div class="container_123" style="width: 1050px; margin: 0; float: left; border: none; margin-right: 100px;">
            <div id="ca-container" class="ca-container" style="width: 1050px; margin-left: 40px;">
