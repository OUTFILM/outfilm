...
if ($_POST["username"] != "") { // Actually do AJAX functions here. That's right; this script is kinda recursive.
	...
	if (strlen($username) < 4 and strlen($username) > 20 ) $error = "Username must be 4-20 characters.";		
...
$(document).ready(function () {
    ...
    // Constantly check fields for validation
    $("#code").on("change", function() {
    	$('#register_form').jqxValidator("validate", "#code");
