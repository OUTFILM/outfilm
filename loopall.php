<?php
    ...
    $query_ALL = "SELECT * FROM catalog WHERE catalog_op NOT LIKE 8 AND catalog_op NOT LIKE 9 AND catalog_op NOT LIKE 3 ORDER BY Datetime DESC LIMIT 6 OFFSET $page_key";
